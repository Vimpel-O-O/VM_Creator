...
# ---------------------------------------------------------
# MAIN MENU (Start + Quit, centered, blue bg, white buttons)
# ---------------------------------------------------------
screen main_menu():

    tag menu

    # full solid blue background (no image)
    add Solid("#244b9f")  # soft blue background covering the full screen

    vbox:
        align (0.5, 0.5)     # perfectly centered
...
# screen where user writes the AI prompt
screen prompt_screen():
    ...
    frame:
        ...
        vbox:
            ...
            text "Describe your story:" color "#0f172a" size 34

            # >>> this is the visible big box <<<
            frame:
                background Solid("#e2e8f0")     # light grey so you SEE it
                xmaximum 900
                xminimum 900
                yminimum 600
                xfill False
                ...
                # the actual input
                input:
                    value VariableInputValue("prompt_text")
                    length 500
                    color "#0f172a"
            ...
            textbutton "OK" action Return() xalign 1.0:
                background Solid("#ffffff")
                text_color "#0f172a"
                xminimum 200
                yminimum 70
...
# ---------------------------------------------------------
# GAME MENU (needed because preferences/load screens call it)
# this shows up when you press ESC / right-click in-game
# ---------------------------------------------------------
screen game_menu(title=None):
    ...
    window:
        background Solid("#00000080")  # transparent dark
        xfill True
        yfill True
